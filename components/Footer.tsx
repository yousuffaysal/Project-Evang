        ...
        <div className="foot-top">
          <div className="foot-brand">
            ...
            <div className="socials">
              ...
              <a href="https://www.linkedin.com/company/evangariwala/posts/?feedView=all" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul>
              ...
              <li><Link href="/#book-form">Book Pickup</Link></li>
